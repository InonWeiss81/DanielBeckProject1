let category_items = [
  ...
  },
  {
    ...
    host_about:
      "(Hidden by Airbnb) Likes:\r\r\nMichael Jackson, Lady Gaga, Jay Brannan, Avatar, Desperate Housewives, Glee, Trueblood, The Ellen DeGeneres Show, The Vampire Diaries, True Blood, Clémentine, ERIC NORTHMAN, Sookie Stackhouse, Human Rights Campaign, Media Contacts, Doğa İçin El Ele, Fashion Blogs, Widgets and Wedgies, Two Dads, Not Playing Farmville, Kathy Griffin, Randomely laughing  because you remembered something funny., Pink Istanbul | Art & Dance Event, Adam Lambert, Gavur İzmir, James Eckhouse, Happy Island, Bodypump, (Website hidden by Airbnb) iTunes",
    host_response_time: "N/A",
    host_response_rate: "N/A",
    host_acceptance_rate: "N/A",
    host_is_superhost: "t",
  ...
  },
  {
    ...
    neighborhood_overview:
      "You will find yourself in a quiet side street of the Canal district by the Jordaan, with everything you need just around the corner. From little cafes and restaurants, a great bakery and an Italian coffee bar, to all kinds of traiteurs, shops and supermarkets. There are two weekly organic markets within 5 minutes walk (Wednesdays and Saturdays).<br /><br />There’s a bike rental 2 minutes walk from the house. It’s just a short train ride from the airport (only 15 minutes) and the station is only 7 minutes walk from the apartment so it’s very quick to get here. Amsterdam is a small city and it’s very easy to get around on foot or by bike or of course by boat!<br /><br />LOCATION DESCRIPTION: <br />Binnen Brouwersstraat is located in a beautiful area of the northern Jordaan, a small side street at the top of the Keizersgracht canal, between the Brouwersgracht canal (voted the most beautiful street in Amsterdam) and the Haarlemmerstraat (voted the Best Shopping Street in the Netherlands) w",
    picture_url:
  ...
  },
  {
    ...
    neighborhood_overview:
      "Around the corner you can sit on the square in a very nice Café, there's a deli and a grocery opposite our house.<br />The area is very scenic, but there are no tourists!<br />Within 5 minutes walking you reach the centre.",
    picture_url:
  ...
  },
  {
    ...
    host_location: "Amsterdam, Noord-Holland, The Netherlands",
    host_about:
      "Hello I'm Peter, I look forward to hearing from you if you'd like to stay in the heart of “De Pijp”, one of the coziest and funkiest neighborhoods of Amsterdam.",
    host_response_time: "N/A",
    host_response_rate: "N/A",
    host_acceptance_rate: "N/A",
    host_is_superhost: "f",
  ...
  },
  {
    ...
    neighborhood_overview:
      "Close to the old Center of Amsterdam<br />Close to Vondelpark<br />Tranquil residential Neighbourhood<br />Nice Trendy restaurants/cafés on the corner<br />Nice Sunny RoofTerrace to relax / enjoy",
    picture_url:
  ...
  },
  {
    ...
    neighborhood_overview:
      "This neighborhood is fantastic! The Baarsjes is on the corner with really nice restaurants, shops and cafés. Also the Westerpark and the Erasmuspark is the best in spring and summertime. <br />If you come i will look up all the nice things to do during the days you will stay in Amsterdam. So you won't miss a thing :-)",
    picture_url:
  ...
  },
  {
    ...
    neighborhood_overview:
      "Residents live in the heart of the city - but that does mean avoiding the occasional wayward tourists on bicycles or revelling party-goers. With the building of the Amsterdam Public Library, one can not only enjoy one of Europe's largest public collections but also the expansive view of Amsterdam Centre from the roof-top café.<br /><br />Southeast of Centraal Station, Oudezijds lays between the city's red carpet Damrak and the scenic Oude Schans canal. It is capped on its southern end by the River Amstel. The Red Light District only takes up a small portion: within a triangle roughly formed by Centraal Station and the two main squares, Dam and Nieuwmarkt.",
    picture_url:
  ...
  },
  {
    ...
    host_location: "Amsterdam, Noord-Holland, The Netherlands",
    host_about:
      "Originally from Canada, Lia's been living abroad for the last 15 years, and Reinier for the last 8 years, most recently landing [very happily] in Amsterdam. We have used Airbnb in Argentina, Canada, Italy, UK, and more and have had wonderful experiences. \r\r\n\r\r\nIf I was forced to choose one destination that was my favourite for traveling, I think I'd have to say South Africa, or Japan.  Both countries have stunning natural diversity, distinctive cultures, vibrant urban lifestyles, and great food.\r\r\n\r\r\n--\r\r\n\r\r\nCanadienne de naissance, ca fait 15 ans que Lia a vécu à l'étranger (au Japon, France, Ghana, les Emirates Arabes Unis, et au Québec) et 8 ans pour Reinier. Nous habitons à Amsterdam depuis 2009/2010 où on veux passer le reste de notre vie.\r\r\n\r\r\nSi j'étais forcé de choisir une destination qui est mon préféré pour voyager, je pense que je dirais l'Afrique du Sud, ou Japon. Les deux pays ont une étonnante diversité naturelle, des cultures distinctives, un vibrant vie urbain, et de l'excellente cuisine.",
    host_response_time: "N/A",
    host_response_rate: "N/A",
    host_acceptance_rate: "N/A",
    host_is_superhost: "f",
  ...
  },
  {
    ...
    host_name: "Gisèle And Simon",
    host_since: "9/11/11",
    host_location: "Amsterdam, Noord-Holland, The Netherlands",
    host_about:
      "we are a happy couple from amsterdam, holland, renting out our lovely two flow flat situated in thé lovely Amsterdam \r\r\n",
    host_response_time: "within a few hours",
    host_response_rate: "100%",
    host_acceptance_rate: "100%",
    host_is_superhost: "f",
...
//function showHead() {
//    console.log(category_items.length);
//    $("#head").empty();
//    let item_content = `<h3> Welcome to AIRBNB </br> We have ` + category_items.length + ` apartments for you </br> BUT you can use our filters to adjust the results! </br> click BUTTON for more details </h3>`;
//    $("#head").append(item_content);
//}
  ...
  category_items.map((cItem) => {
    if (cItem.id == id) {
      ...
      for (let i = 0; i < myFavourites.length; i++) {
        if (myFavourites[i]["id"] == id) doesExist = true;
      }
      if (!doesExist) myFavourites.push(cItem);
...
function card(category_item, key) {
  let item_content =
    ...
    '"alt="picture_url" />' +
      `<p><br>` +
      `<button class="button" onclick={addBooking(${key})}>blabla</button>` + "</p>" +
      "<p>" +
      `<p><br>` +
